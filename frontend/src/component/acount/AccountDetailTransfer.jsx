...
// //         try {
// //             const response = await axios.get(`http://localhost:6700/api/account/paymentdetail/${id}`);
...
// //                 <Navbar />
// //             </div>
// //             <div className="py-12 px-6 print:py-0 print:px-0 md:ml-64 bg-gray-100 dark:bg-gray-700" id="invoice">
// //                 <div className="p-4 mt-5 bg-white print:bg-transparent dark:border-gray-700 print:bg-white print:p-0 print:shadow-none">
// //                     <div className="my-4">
// //                         <Link to="/account" className="text-white py-2 px-4 bg-blue-500 rounded print:hidden">
// //                             Back
// //                         </Link>
// //                     </div>
...
// //                                         <td className="border border-gray-400 px-4 py-2">{detail.detail_balance || 'NA'}</td>
...
//                                 <label htmlFor="startDate">ថ្ងៃទីចាប់ផ្ដើុម</label>
//                                 <input
//                                     type="date"
//                                     id="startDate"
...
//                                 <button
//                                     className="px-8 py-3 text-white bg-blue-500 rounded hover:bg-blue-700"
