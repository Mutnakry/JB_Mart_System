...
//     try {
//       const response = await axios.get('http://localhost:6700/api/customer/1');
//       setCustomers(response.data); // Default to an empty array if no data
//     } catch (error) {
//       console.error('Error fetching customers data', error);
//       toast.error('Error fetching customers data'); // Optional: Notify the user
//     }
//   };
...
//   const [CashBalance, setCastbalence]=useState(0);
...
//     const newFinalTotal = finalTotal - payMoney;
//     setPayment(newFinalTotal);
//     const Cash_dipotit = payMoney - finalTotal;
//     setDeposit(Cash_dipotit);
//     const Cash_balance = finalTotal - payMoney;
//     setCastbalence(Cash_balance);
//   };
...
//       updateQuantity(item.id, newQuantity); // Call the context method to update quantity
//     } else {
//       removeItem(item.id); // Remove item if quantity is reduced to zero
//     }
//   };
...
//                           placeholder={finalTotal} required
//                         />
//                       </div>
//                       <div class="w-1/2 pr-2 ">
...
//                       <span class="block text-lg mb-2">{(payment)} $</span>
//                     </div>
//                     <div class="mb-4 border-b border-gray-400">
//                       <span class="block font-semibold">សមតុល្យសាច់ប្រាក់:</span>
//                       <span class="block text-lg mb-2">{CashBalance} $</span>
//                     </div>
//                     <div class="mb-2">
//                       <span class="block font-semibold">សរុបសំរាប់:</span>
//                       <span class="block text-lg mb-2">{Deposit} $</span>
//                     </div>
//                   </div>
//                 </div>
//               </div>
...
//                   <button class="button_only_close">បិទ</button>
