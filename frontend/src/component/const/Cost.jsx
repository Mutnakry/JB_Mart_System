...
//         setLoading(true);
//         try {
//             const response = await axios.get('http://localhost:6700/api/cost', {
//                 params: {
//                     page,
//                     limit,
...
//         if (selectedcostId) {
//             try {
//                 await axios.delete(`http://localhost:6700/api/cost/${selectedcostId}`);
...
//                                                 ) : null}
//                                             </td>
//                                             <td className="px-4 py-1">{customer.tax} $</td>
//                                             <td className="px-4 py-1">{customer.price} $</td>
//                                             <td className="px-4 py-1">{customer.payment} $</td>
