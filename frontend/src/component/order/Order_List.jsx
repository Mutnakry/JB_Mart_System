                            ...
                            {loading ? (
                                ...
                                <tbody>
                                    {orders?.map((order, index) => (
                                        <motion.tr key={order.order_detail_id}
                                            initial="hidden"
                                            animate="visible"
                                            exit="exit"
                                            ...
                                            <td className="px-4 py-1">{formatDateToKhmer(new Date(order.date_order))}</td>
                                            <td className="px-4 py-2">{(order.full_names || order.business_names)}</td>
                                            <td className="px-4 py-2">{order.totalqty} {order.unit_names}</td>
                                            <td className="px-4 py-2 text-sm whitespace-nowrap">
                                                {order.type_currency === "usd" ? (
                                                    ...
                                                    <div>
                                                        <span >
                                                            {order.total_amount}   រៀល
                                                        </span>
                                                    </div>
                                                ) : order.type_currency === "thb" ? (
                                                    <div>
                                                        <span>
                                                            {order.total_amount} បាត
                                                        </span>
                                                    </div>
                                                ) : null}
                                            </td>
                                            <td className="px-4 py-2">{order.total_amount_dola} $</td>
                                            <td className="px-4 py-2 text-sm whitespace-nowrap">
                                                {order.type_currency === "usd" ? (
                                                    <div>
                                                        <span >
                                                    ...
                                                    <div>
                                                        <span >
                                                            {order.balance_amount}   រៀល
                                                        </span>
                                                    </div>
                                                ) : order.type_currency === "thb" ? (
                                                    <div>
                                                        <span>
                                                            {order.balance_amount} បាត
                                                        </span>
                                                    </div>
                                                ) : null}
                                            </td>
                                            {/* <td className="px-4 py-2">{order.balance_amount} {order.type_currency}</td> */}
                                            <td className="px-4 py-2 text-sm whitespace-nowrap">
                                                {order.type_currency === "usd" ? (
                                                    <div>
                                                        <span >
                                                    ...
                                                    <div>
                                                        <span >
                                                            {(order.total_amount) - (order.balance_amount)}   រៀល
                                                        </span>
                                                    </div>
                                                ) : order.type_currency === "thb" ? (
                                                    <div>
                                                        <span>
                                                            {(order.total_amount) - (order.balance_amount)} បាត
                                                        </span>
                                                    </div>
                                                ) : null}
                                            </td>
                                            <td className="px-4 py-2">{order.totalDiscount} $</td>
                                            <td className="px-4 py-2">{order.description}</td>
                                            <td className="px-4 py-2 text-center">{order.user_at || 'Unknown'}</td>
