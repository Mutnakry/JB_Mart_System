...
function customer_payment() {
    ...
    const handleSubmit១ = async (e) => {
        ...
        try {
            ...
            const calculatedPayMoney = totalAmount - (balanceAmount + discount);
            ...
            if (ispaymentTypeCurrency === "khr" && exchangeRateKHR) {
                ...
                exchangeRate = 1 / exchangeRateKHR;
                ...
                exchangeRate = thbToKhrRateTHB / exchangeRateKHR;
            }

            setBalance_usd(convertedAmountUSD);
            ...
            const purchaseData = {
                ...
                balance: newPayment,
                cash_change,
                balance_usd: convertedAmountUSD,
