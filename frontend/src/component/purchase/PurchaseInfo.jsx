...
//                                             <td className="px-4 py-1 text-center" dangerouslySetInnerHTML={{ __html: purchase.product_names }}></td>
//                                             <td className="px-4 py-1 text-center" dangerouslySetInnerHTML={{ __html: purchase.grou_qty }}></td>
...
//                                                 </button>
//                                             </td>
//                                             <td className="px-4 py-1 text-center">{purchase.total_include_tax} $</td>
...
//                                     {purchases?.map((purchase, index) => {
//                                         const remainingAmount = purchase.total_amount - purchase.amount_pay;
//                                         return (
//                                             <motion.tr key={purchase.id}
//                                                 initial="hidden"
//                                                 animate="visible"
...
//                                                 transition={{ duration: 0.3 }}
//                                                 className={`text-sm font-NotoSansKhmer hover:scale-y-110 duration-100 
//                                                     ${remainingAmount > 0 ? 'bg-red-400' :
//                                                         remainingAmount === 0 ? 'bg-blue-400' :
//                                                             'bg-green-400'}`}
//                                             >
//                                                 <td className="px-4 py-1">{index + 1}</td>
//                                                 <td className="px-4 py-1">{formatDateToKhmer(new Date(purchase.purchase_date))}</td>
...
//                                                     <button onClick={() => openUpdateModal(purchase)}>
//                                                         {purchase.status === 'active' ? (
//                                                             <span>កំពុងរងចាំ</span>
//                                                         ) : purchase.status === 'pending' ? (
//                                                             <span>បានបញ្ជាទិញ</span>
//                                                         ) : purchase.status === 'completed' ? (
//                                                             <span>បានទទួល</span>
//                                                         ) : (
//                                                             <span className='bg-gray-500 py-1 px-4 rounded text-white'>មិនមានស្ថានភាព</span>
//                                                         )}
//                                                     </button>
//                                                 </td>
//                                                 <td className="px-4 py-1 text-center">{purchase.total_include_tax} $</td>
...
//                                                 <td className="px-4 py-1">{purchase.total_amount} $</td>
//                                                 <td className="px-4 py-1 text-center">{purchase.amount_pay} $</td>
//                                                 <td className="px-4 py-1 text-center">{remainingAmount.toFixed(2)} $</td>
