                    ...
                    <div className="grid grid-cols-1 gap-4 mb-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        ...
                        <div className="flex items-center h-24 px-5 bg-white border-t-2 border-yellow-500">
                            ...
                            <div className="flex items-center justify-between w-full px-5 text-xs md:text-lg whitespace-nowrap">
                                <h3 className="font-bold text-gray-700 font-NotoSansKhmer">លក់សរុប​១</h3>
                                <div className="text-right">
                                    <h3 className="font-bold text-gray-700 font-NotoSansKhmer">{sum_order[0]?.TotalAmountUSD || 0} $</h3>
                                    <h3 className="font-bold text-gray-700 font-NotoSansKhmer">{sum_order[0]?.TotalAmountKHR || 0} រៀល</h3>
                                    <h3 className="font-bold text-gray-700 font-NotoSansKhmer">{sum_order[0]?.TotalAmountTHB || 0} បាត</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center h-24 px-5 bg-white border-t-2 border-yellow-500 ">
                            ...
                            {/* Title and Financial Info */}
                            <div className="flex items-center justify-between w-full px-5 text-xs md:text-lg whitespace-nowrap">
                                <h3 className="font-bold text-gray-700 font-NotoSansKhmer">លក់ជំពាក់ 1</h3>
                                <div className="text-right">
                                    <h3 className="font-bold text-gray-700 font-NotoSansKhmer">{sum_order[0]?.ResultTotal_DiUSD || 0} $</h3>
                                    <h3 className="font-bold text-gray-700 font-NotoSansKhmer">{sum_order[0]?.ResultTotal_DiKHR || 0} រៀល</h3>
                                    <h3 className="font-bold text-gray-700 font-NotoSansKhmer">{sum_order[0]?.ResultTotal_DiTHB || 0} បាត</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center h-24 bg-white border-t-2 border-blue-600">
                            <div className='flex items-center gap-4 mx-5'>
                                ...
                                <div>
                                    ...
                                    <h3 className='font-bold text-gray-600 font-NotoSansKhmer'>អតិថិជនសរុប 1</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center h-24 bg-white border-t-2 border-orange-500">
                            <div className='flex items-center gap-4 mx-5'>
                                ...
                                <div>
                                    ...
                                    <h3 className='font-bold text-gray-600 font-NotoSansKhmer'>ទំនិញសរុប 1</h3>
                                </div>
                            </div>
                        </div>
                    </div>
