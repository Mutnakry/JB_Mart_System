...
// //                 dashArray: [0, 0, 5] // Dashed line for stock_total
// //             },
// //             markers: {
// //                 size: 4, // Small dots at data points
// //                 colors: ["#008FFB", "#FF4560", "#00E396"], // Colors for each line
// //                 strokeWidth: 2
// //             },
// //             dataLabels: {
// //                 enabled: false
...
// //     //                 const stock_total = response.data.map((item) => Number(item.stock_total) || 0);
// //     //                 setChartData((prev) => ({
// //     //                     ...prev,
// //     //                     series: [
// //     //                         { name: "ចំនួនផលិតផលនៅក្នុងស្តុក", data: stockIn },
// //     //                         { name: "ចំនួនផលិតផលលក់ចេញ", data: stockOut },
// //     //                         { name: "ចំនួនផលិតផលសរុបទាំងអស់", data: stock_total } // Add Stock Total
// //     //                     ],
...
// //                         (item) => `${item.pro_names} (${item.unit_names})` // Append unit names
// //                     );
// //                     const stockIn = response.data.map((item) => Number(item.stock_IN) || 0);
// //                     const stockOut = response.data.map((item) => Number(item.stock_OUT) || 0);
