...
const { PurchaseDetailAll,PurchaseProduct,PurchaseSale,SumTotalSale_Dolla_INYear,CostPrice,CountProduct,Sum_PurchaseDetail,StockProduct,SaleProduct_Dolla_InDay,SumTotalSale_USD_KHR_THB_inMonth,CountProductQTYSale,CountCustomer,OrderSum} = require('../controller/dashboard_chart.controller');
